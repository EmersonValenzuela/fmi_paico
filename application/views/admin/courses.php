                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Cursos</h4>
                                            ...
                                            <table id="report-table" class="table table-bordered table-striped mb-0">
												...
												foreach ($cursos as $curso) {
                                                    ...
                                                    <tr data-id="<?=$curso['id_curso']?>">
                                                        <td><img src="<?= base_url();?>assets/img/cursos/<?=$curso['img_curso']?>" alt="<?=$curso['img_curso']?>" class="img-radius" width="30px" height="30px"></td>
                                                        <td><?=$curso['nombre_curso']?></td>
                                                        <td><?=$curso['name']?></td>
                                                        <td><?=$curso['fecha_curso']?></td>
														<td><?=$curso['nombre_categoria']?></td>
                                                        <td>
														<form action="<?= base_url();?>courses/curso" method="post">
														<input type="hidden" name="idcurso" value="<?=$curso['id_curso']?>">
                                                            <button class="btn btn-info btn-sm" data-style="slide-up">Ver</button>
														</form>
														<form action="<?=base_url();?>courses/delete" method="post">
