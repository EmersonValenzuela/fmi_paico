                            ...
                            <div class="row no-gutters row-bordered row-border-light">
                                ...
                                <div class="col-md-9">
                                    <div class="tab-content">
										...
										<form action="<?= base_url(); ?>courses/edit" method="post" enctype="multipart/form-data">
                                            <div class="card-body media align-items-center">
                                                <img src="<?= base_url();?>assets/img/cursos/<?=$curso['img_curso']?>" alt="" class="d-block ui-w-80">
											...
											<input type="hidden" name="foto" value="<?=$curso['img_curso']?>">
											<input type="hidden" name="idcurso" value="<?=$curso['id_curso']?>">
												...
												<select class="select2-demo form-control" style="width: 100%" data-allow-clear="true" name="categoria">
													<option value="<?=$curso['categoria']?>"><?=$curso['nombre_categoria']?></option>
													<?php
                                                ...
                                                <div class="form-group">
													...
													<input type="text" class="form-control mb-1" name="nombre_curso" value="<?=$curso['nombre_curso']?>">
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Descripción Curso</label>
                                                    <textarea id="autosize-demo" rows="3" name="descripcion_curso" class="form-control"><?=$curso['descripcion_curso']?></textarea>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Beneficio Curso</label>
                                                    <textarea id="autosize-demo" rows="3" name="beneficio_curso" class="form-control"><?=$curso['beneficio_curso']?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Silabus Curso</label>
                                                    <textarea id="autosize-demo" rows="3" name="silabus_curso" class="form-control"><?=$curso['silabus_curso']?></textarea>
                                                    
												</div>
												<div class="form-group">
												<h6>Seleccionar Profesor</h6>
												<select class="select2-demo form-control" style="width: 100%" data-allow-clear="true" name="id_profesor">
													<option disable value="<?=$curso['id_profesor']?>"><?=$curso['name']?></option>
													<?php
